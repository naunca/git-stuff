...
alias pa="pico ~/git-stuff/.bash_aliases;source ~/git-stuff/.bash_aliases"
...
alias gitconfig="git config --global user.name \"C N\";git config --global user.email \"k5n@yahoo.com\";git config -l"
